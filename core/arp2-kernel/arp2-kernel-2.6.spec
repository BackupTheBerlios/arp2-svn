...
Source32: kernel-%{kversion}-i686-xen0.config
Source33: kernel-%{kversion}-i686-xenU.config
...
Patch1640: linux-2.6-ide-floppy-eject.patch
...
Patch1752: linux-2.6-agp-sworks-hang.patch
...
* Wed Nov  9 2005 David Woodhouse <dwmw2@redhat.com>
- Fix kernel-devel headers on PPC
- Include DVB headers

* Sat Nov  5 2005 Dave Jones <davej@redhat.com>
- Fix FPU corruption on return from S3. (#140257)
- Fix up DMI usage in i8k driver.

* Sat Nov  5 2005 Dave Jones <davej@redhat.com> [2.6.14-1.1636_FC4]
- Increase firmware loader timeout.

* Fri Nov  4 2005 Dave Jones <davej@redhat.com>
- Stop kauditd from preventing suspend.

* Thu Nov  3 2005 Dave Jones <davej@redhat.com> [2.6.14-1.1634_FC4]
...
* Thu Oct 06 2005 Dave Jones <davej@redhat.com>
- Fix information leak in orinoco driver.

* Wed Oct 05 2005 Dave Jones <davej@redhat.com>
- Further fixing to the 8139too suspend/resume problem.

* Mon Oct 03 2005 Dave Jones <davej@redhat.com> [2.6.13-1.1528_FC4]
- 2.6.13.3

* Sun Oct 02 2005 Dave Jones <davej@redhat.com> [2.6.13-1.1527_FC4]
...
* Wed Sep 28 2005 Dave Jones <davej@redhat.com> [2.6.13-1.1526_FC4]
...
* Fri Sep 23 2005 Dave Jones <davej@redhat.com> [2.6.13-1.1525_FC4]
- Fix some emu10k1/ac97 bugs. (#169152)
- Fix aic7xxx issue with >4GB. (#167049)

* Tue Sep 20 2005 Dave Jones <davej@redhat.com>
- 2.6.13.2

* Sun Aug 28 2005 Dave Jones <davej@redhat.com>
- 2.6.13 final.

* Sat Aug 27 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc7-git2
...
* Thu Aug 25 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc7-git1
- FUTEX_WAKE_OP support.

* Tue Aug 23 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc7
...
* Mon Aug 22 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git13

* Sat Aug 20 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git12
...
* Fri Aug 19 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git11

* Thu Aug 18 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git10
...
* Sun Aug 14 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git6

* Sat Aug 13 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git5
...
* Tue Aug 09 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc6-git1
...
* Mon Aug 08 2005 Dave Jones <davej@redhat.com>
...
* Sat Aug 06 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc5-git4
...
* Thu Aug 04 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc5-git2

* Wed Aug 03 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc5-git1
...
* Thu Jul 28 2005 David Woodhouse <dwmw2@redhat.com>
- Enable i8042 and Amiga partitions on PPC (for Pegasos II, CHRP)

* Wed Jul 27 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc3-git8

* Mon Jul 25 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc3-git7

* Sat Jul 23 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc3-git5

* Mon Jul 18 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc3-git4

* Sun Jul 17 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc3-git4
...
* Fri Jul 08 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc2-git2

* Thu Jul 07 2005 Dave Jones <davej@redhat.com>
- Fix exec-shield to not randomize to between end-of-binary and start-of-brk

* Wed Jul 06 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc2

* Tue Jul 05 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc1-git7
...
* Mon Jul 04 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc1-git6

* Fri Jul 01 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc1-git3
  - Xen broke again, so is temporarily disabled. Sorry :(
- Add a vdso marker to /proc/*/maps even if the vDSO is randomized

* Thu Jun 30 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc1-git2

* Wed Jun 29 2005 Dave Jones <davej@redhat.com>
- 2.6.13-rc1

* Tue Jun 28 2005 Dave Jones <davej@redhat.com>
- 2.6.12-git10
...
* Tue Jun 21 2005 Dave Jones <davej@redhat.com>
- 2.6.12-git3
  - Welcome back Tux.
...
* Mon Jun 13 2005 Peter Jones <pjones@redhat.com>
- Reenable fixed ipw drivers.

* Mon Jun 13 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc6-git5

* Thu Jun 09 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc6-git3
...
* Mon Jun  6 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc6
- Copy asm-i386 into x86-64's kernel-devel too. (#150266)

* Sat Jun  4 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc5-git9

* Fri Jun  3 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc5-git8

* Thu Jun  2 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc5-git7
...
* Sat May 28 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc5-git3

* Fri May 27 2005 Dave Jones <davej@redhat.com>
- 2.6.12-rc5-git2

* Thu May 26 2005 Dave Jones <davej@redhat.com>
