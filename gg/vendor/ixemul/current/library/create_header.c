...
#define LIB struct pOS_Library
#define TASK struct pOS_Task
#else
...
#ifdef __pos__
#define SYSTEM_CALL(func, vec, args) extra = vec;
...
#ifdef __pos__
  printf ("#define EXTSTTAG_MainOSID %d\n", EXTSTTAG_MainOSID);
  printf ("#define pOS_MAINOSID %d\n", pOS_MAINOSID);
  printf ("#define TAG_END %d\n", TAG_END);
#endif
