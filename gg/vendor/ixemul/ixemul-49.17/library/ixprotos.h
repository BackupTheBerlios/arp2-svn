...
void    ix_panic(const char *msg, ...) __attribute__((varargs68k));
void    panic(const char *msg, ...) __attribute__((varargs68k));
void    ix_warning(const char *msg, ...) __attribute__((varargs68k));
