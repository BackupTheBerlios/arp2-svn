	...
	if (private_startup < 0) /* ppc code */
	...
	else /* 68k code */
	  {
	    ...
	    */
	    ...
	    struct EmulCaos caos;
	    caos.caos_Un.Function = (APTR)trampoline;
	    caos.reg_d0 = (ULONG)ixemulbase;
	    caos.reg_d1 = (ULONG)f;
	    caos.reg_d2 = (ULONG)argv;
	    caos.reg_d3 = (ULONG)environ;
	    caos.reg_d4 = (ULONG)0;
	    caos.reg_a0 = (ULONG)entry;
	    u.p_xstat = MyEmulHandle->EmulCall68k(&caos);
	  }
#else
	u.p_xstat = entry(ixemulbase, f, argv, environ, 0);
#endif
