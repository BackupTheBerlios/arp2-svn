...
sec_out_mcs_data(STREAM s)
{
	...
	out_uint16_be(s, ((14+140+12) | 0x8000));	/* remaining length */
	...
	out_uint16_be(s, ((140+12) | 0x8000));	/* remaining length */

	/* Client information */
	out_uint16_le(s, SEC_TAG_CLI_INFO);
	out_uint16_le(s, 140);	/* length */
	out_uint16_le(s, 1);
	out_uint16_le(s, 8);
	...
	switch( rdp_bitmap_bits ){
		case 8:
			out_uint16_le(s, 0xca01); /* 8-bit color */
			break;
		case 16:
			out_uint16_le(s, 0xca03); /* 16-bit color */
			break;
	}
	...
	out_uint32_le(s, 0); /* extEncryptionMethod */
